...
hold on
loglog(rjb_vec, medianvec(2,:),'-.','color',ascolor,'Linewidth',1)
...
loglog(rjb_vec, medianvec(6,:),'-.','color',bacolor,'Linewidth',1)
loglog(rjb_vec, medianvec(7,:),'-','color',bacolor,'Linewidth',1)
loglog(rjb_vec, medianvec(8,:),'-.','color',excolor,'Linewidth',1)
...
loglog(rjb_vec, medianvec(15,:),'-.','color',othercolor,'Linewidth',1)
loglog(rjb_vec, medianvec(16,:),':','color',excolor,'LineWidth',1);
grid on 
axis(limits)
xlabel('RJB Distance [km]')
ylabel('PSA [g]')
title("PSA versus Rjb Distance")
legend('a2015','as1997','as2008','ask2014','ba2008','bjf1997','bssa2014','c1997','cb2008','cb2014','cy2008','cy2014','i2014','scemy1997','z2006','Location','Southwest')
